...
var example = {
  ...
  "hero-video-dialog-demo-top-in-bottom-out": {
    ...
    component: React.lazy(
      () => import("@/registry/components/example/hero-video-dialog-demo-top-in-bottom-out")
    )
  },
  "marquee-demo": {
    name: "marquee-demo",
  ...
  "animated-circular-progress-bar-demo": {
    ...
    component: React.lazy(
      () => import("@/registry/components/example/animated-circular-progress-bar-demo")
    )
  },
  "shine-border-demo": {
...
var computedFields = {
  ...
  image: {
    type: "string",
    resolve: (post) => `${process.env.NEXT_PUBLIC_APP_URL}/og?title=${encodeURI(post.title)}`
  },
  slug: {
    type: "string",
...
var Showcase = defineDocumentType(() => ({
  name: "Showcase",
...
//# sourceMappingURL=compiled-contentlayer-config-NYFPSOVB.mjs.map
