...
const frameworks = [
  {
    ...
    icon: (
      ...
      >
        ...
        {/* Body */}
      <path
        d="M50 95c-20 0-30-15-30-35s10-45 30-45 30 25 30 45-10 35-30 35z"
        fill="#000000"
      />
      {/* Belly */}
      <path
        d="M50 90c-15 0-20-15-20-30s5-35 20-35 20 20 20 35-5 30-20 30z"
        fill="#FFFFFF"
      />
      {/* Left foot */}
      <path
        d="M35 85c-5 0-10-5-10-10s5-10 10-10 10 5 10 10-5 10-10 10z"
        fill="#FFA500"
      />
      {/* Right foot */}
      <path
        d="M65 85c-5 0-10-5-10-10s5-10 10-10 10 5 10 10-5 10-10 10z"
        fill="#FFA500"
      />
      {/* Beak */}
      <path
        d="M50 55c-5 0-10-2-10-5s5-10 10-10 10 7 10 10-5 5-10 5z"
        fill="#FFA500"
      />
      {/* Left eye */}
